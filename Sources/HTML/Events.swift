...
extension Attribute where Tag: HTMLTags.Abortable {
	...
	@inlinable public static func onAbort(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Failable {
	...
	@inlinable public static func onError(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Loadable {
	...
	@inlinable public static func onLoad(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onAnimationStart(_ script: consuming Script) -> Self {
		.init(name: "onanimationstart", value: script)
	}

	/// Fires when a CSS animation completes.
	@inlinable public static func onAnimationEnd(_ script: consuming Script) -> Self {
		.init(name: "onanimationend", value: script)
	}

	/// Fires at the end of each iteration of a repeating CSS animation.
	@inlinable public static func onAnimationIteration(_ script: consuming Script) -> Self {
		.init(name: "onanimationiteration", value: script)
	}

	/// Fires when a CSS animation is unexpectedly cancelled.
	@inlinable public static func onAnimationCancel(_ script: consuming Script) -> Self {
		.init(name: "onanimationcancel", value: script)
	}

	/// Fires when a CSS transition starts.
	@inlinable public static func onTransitionStart(_ script: consuming Script) -> Self {
		.init(name: "ontransitionstart", value: script)
	}

	/// Fires when a CSS transition completes.
	@inlinable public static func onTransitionEnd(_ script: consuming Script) -> Self {
		.init(name: "ontransitionend", value: script)
	}

	/// Fires when a CSS transition is unexpectedly cancelled.
	@inlinable public static func onTransitionCancel(_ script: consuming Script) -> Self {
		.init(name: "ontransitioncancel", value: script)
	}

	/// Fires when a CSS transition is created and begins delaying.
	@inlinable public static func onTransitionRun(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onCopy(_ script: consuming Script) -> Self {
		.init(name: "oncopy", value: script)
	}

	/// Fires when content is cut from the element.
	@inlinable public static func onCut(_ script: consuming Script) -> Self {
		.init(name: "oncut", value: script)
	}

	/// Fires when content is pasted into the element.
	@inlinable public static func onPaste(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onCommand(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onBeforeToggle(_ script: consuming Script) -> Self {
		.init(name: "onbeforetoggle", value: script)
	}

	/// Fires when a modal dialog is cancelled, e.g. via the Escape key.
	@inlinable public static func onCancel(_ script: consuming Script) -> Self {
		.init(name: "oncancel", value: script)
	}

	/// Fires when a dialog is closed.
	@inlinable public static func onClose(_ script: consuming Script) -> Self {
		.init(name: "onclose", value: script)
	}

	/// Fires when a details, dialog, or popover element's open state changes.
	@inlinable public static func onToggle(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onBlur(_ script: consuming Script) -> Self {
		.init(name: "onblur", value: script)
	}

	/// Fires when the element gains focus.
	@inlinable public static func onFocus(_ script: consuming Script) -> Self {
		.init(name: "onfocus", value: script)
	}

	/// Fires when the element gains focus (bubbling focus).
	@inlinable public static func onFocusIn(_ script: consuming Script) -> Self {
		.init(name: "onfocusin", value: script)
	}

	/// Fires when the element loses focus (bubbling blur).
	@inlinable public static func onFocusOut(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onChange(_ script: consuming Script) -> Self {
		.init(name: "onchange", value: script)
	}

	/// Fires when the value of an input-like element changes as the user types.
	@inlinable public static func onInput(_ script: consuming Script) -> Self {
		.init(name: "oninput", value: script)
	}

	/// Fires when a form control fails constraint validation.
	@inlinable public static func onInvalid(_ script: consuming Script) -> Self {
		.init(name: "oninvalid", value: script)
	}

	/// Fires when a form is reset.
	@inlinable public static func onReset(_ script: consuming Script) -> Self {
		.init(name: "onreset", value: script)
	}

	/// Fires when text within the element is selected.
	@inlinable public static func onSelect(_ script: consuming Script) -> Self {
		.init(name: "onselect", value: script)
	}

	/// Fires when a form is submitted.
	@inlinable public static func onSubmit(_ script: consuming Script) -> Self {
		.init(name: "onsubmit", value: script)
	}

	/// Fires before editable content is changed.
	@inlinable public static func onBeforeInput(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onFullscreenChange(_ script: consuming Script) -> Self {
		.init(name: "onfullscreenchange", value: script)
	}

	/// Fires when the browser cannot switch to fullscreen mode.
	@inlinable public static func onFullscreenError(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onKeyDown(_ script: consuming Script) -> Self {
		.init(name: "onkeydown", value: script)
	}

	/// Fires when a key is released while the element has focus.
	@inlinable public static func onKeyUp(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Playable {
	...
	@inlinable public static func onPause(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onBeforeMatch(_ script: consuming Script) -> Self {
		.init(name: "onbeforematch", value: script)
	}

	/// Fires when a Content Security Policy is violated.
	@inlinable public static func onSecurityPolicyViolation(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onPointerRawUpdate(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Resizable {
	...
	@inlinable public static func onResize(_ script: consuming Script) -> Self {
...
extension Attribute where Tag: HTMLTags.Visible {
	...
	@inlinable public static func onScroll(_ script: consuming Script) -> Self {
		.init(name: "onscroll", value: script)
	}

	/// Fires when element scrolling has completed.
	@inlinable public static func onScrollEnd(_ script: consuming Script) -> Self {
...
extension Attribute where Tag == HTMLTags.Canvas {
	...
	@inlinable public static func onContextLost(_ script: consuming Script) -> Self {
		.init(name: "oncontextlost", value: script)
	}

	/// Fires if the user agent restores the backing storage.
	@inlinable public static func onContextRestored(_ script: consuming Script) -> Self {
...
extension Attribute where Tag == HTMLTags.Form {
	...
	@inlinable public static func onFormData(_ script: consuming Script) -> Self {
...
extension Attribute where Tag == HTMLTags.Slot {
	...
	@inlinable public static func onSlotChange(_ script: consuming Script) -> Self {
...
extension Attribute where Tag == HTMLTags.Track {
	...
	@inlinable public static func onCueChange(_ script: consuming Script) -> Self {
